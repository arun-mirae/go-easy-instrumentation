...
1. Clone this repository to a directory on your system. For example:
    ```sh
    git clone https://github.com/arun-mirae/go-easy-instrumentation.git
    ```
...
To learn more about how to contribute features to this project, read the [parser readme](/parser/README.md). The [godoc](https://pkg.go.dev/github.com/arun-mirae/go-easy-instrumentation) for this project is also kept up to date, and can be a great resource.
